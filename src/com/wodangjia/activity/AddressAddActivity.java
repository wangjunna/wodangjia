...
public class AddressAddActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ActivityUtils.setActionBarLayout(getActionBar(), this,
				R.layout.title_bar_address_add);
	...
	public void addAddress() {
		...
		address=new Address(App.user.getUser_id(), nameEdit.getText().toString(), phoneEdit.getText().toString(), v_province, v_city, v_county, addrEdit.getText().toString(), "");
		dialog.show();
		
		RequestParams params = new RequestParams();
		params.addBodyParameter(Config.KEY_ACTION,Config.ACTION_CREATE_ADDRESS);
		...
		App.httpclient.send(HttpMethod.POST, Config.API_URL, params,
				new RequestCallBack<String>() {
					...
					public void onFailure(HttpException arg0, String arg1) {
						...
						StringUtils.showToast(AddressAddActivity.this, Config.ERROR_UNCONNECTION_INTERNET);
						dialog.dismiss();
					}
					@Override
					public void onSuccess(ResponseInfo<String> arg0) {
						...
						if(status==0){
							StringUtils.showToast(AddressAddActivity.this, "增加收货地址成功！");
	...
	public void onClick(View v) {
		...
		case R.id.address_submit_btn:
			StringUtils.showToast(this, "单击了保存并使用");
			addAddress();
			break;
