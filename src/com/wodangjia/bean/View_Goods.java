...
public class View_Goods implements Serializable{
	...
	public View_Goods(int goods_id, int user_id, int goods_type,
			String goods_title, String goods_subtitle, int goods_stock,
			double goods_price, int goods_status, String goods_create_time,
			String goods_modify_time, int goods_sales, int collections,double star) {
		super();
		this.goods_id = goods_id;
		this.user_id = user_id;
		this.goods_type = goods_type;
	...
	public String toString() {
		return "View_Goods [goods_id=" + goods_id + ", user_id=" + user_id
				+ ", goods_type=" + goods_type + ", goods_title=" + goods_title
				+ ", goods_subtitle=" + goods_subtitle + ", goods_stock="
				+ goods_stock + ", goods_price=" + goods_price
				+ ", goods_status=" + goods_status + ", goods_create_time="
				+ goods_create_time + ", goods_modify_time="
				+ goods_modify_time + ", goods_sales=" + goods_sales
				+ ", collections=" + collections + ", star=" + star
